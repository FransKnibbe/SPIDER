...
<body>
<h1>Over SPIDER</h1>
<p>SPIDER staat (voorlopig) voor Semantic Perspectives and Interlinked Data from E-humanities Research. In dit project willen we de meerwaarde van toepassing van de principes van Linked Data bij de publicatie van resultaten van wetenschappelijk onderzoek in de geesteswetenschappen aantonen.
...
In dit project zouden deze theoretische voordelen via praktische toepassing aangetoond moeten worden, zodanig dat andere onderzoekers geïnspireerd en aangespoord worden om verder te bouwen het dataweb.</p>
</body>
</html>