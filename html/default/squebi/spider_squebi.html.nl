...
<section>
<h1>Squebi</h1>
<p>Dit is de <a href="https://github.com/tkurz/squebi">Squebi</a> SPARQL client. Squebi kan op elke website worden geïnstalleerd. Het is hier ingesteld op het SPARQL-endpoint van SPIDER (http://data.spider-ld.org/marmotta/sparql/select?query=).</p>
