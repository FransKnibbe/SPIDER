...
<section>
  ...
  Het opvragen van een URI kan via de webbrowser, via de <a href="https://nl.wikipedia.org/wiki/Command-line-interface">commandoregel</a> met behulp van hulpmiddelen als <a href="https://en.wikipedia.org/wiki/CURL">cURL</a> of <a href="https://en.wikipedia.org/wiki/Wget">Wget</a>, of in programmacode.</p>
  ...
  <h2>Data dumps</h2>
  <p>Datasets zijn compleet te downloaden via <a href="http://spider-ld.org/data">de map met datadumps</a>. Dat geeft de mogelijkheid de gegevens in een eigen databank op te slaan.</p>
  <h2>Bevraging</h2>
  Om selecties van data te maken en die op te vragen kan de ondervragingstaal <a href="https://nl.wikipedia.org/wiki/SPARQL">SPARQL</a> worden gebruikt. 
  </p>
  <h1>Datasets</h1>
